...
public class SetPitchRequest extends AbstractRequest {
    @Override
    public List<AbstractCommand> getCommandsBasedOnStateMachine(StateMachine stateMachine, CommandCreator cmdCreate) {
        ...
        cmds.add(cmdCreate.createCommand(CommandType.setIkPitch,value,false));
        return cmds;
    }

    public SetPitchRequest(float value) {
        super(value);
    }
