...
public class SetRollRequest extends AbstractRequest {
    ...
    public List<AbstractCommand> getCommandsBasedOnStateMachine(StateMachine stateMachine, CommandCreator cmdCreate) {
        ...
        cmds.add(cmdCreate.createCommand(CommandType.setIkRoll,value,false));
        return cmds;
    }

    public SetRollRequest(float value) {
        super(value);
    }
